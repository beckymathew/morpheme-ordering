...
with open("visualize/comparison.tex", "w") as outFile:
   ...
   for i in range(len(real)):
       color = {"Voice,TAM" : None, "Valence" : "orange", "Voice" : "green", "TAM" : "blue", "Agreement" : "purple", "NA" : None, "Derivation" : None}[alignment[real[i]]]
   ...
   for i in range(len(optimized)):
       color = {"Voice,TAM" : None, "Valence" : "orange", "Voice" : "green", "TAM" : "blue", "Agreement" : "purple", "NA" : None, "Derivation" : None}[alignment[optimized[i]]]
