...
with open("results/forWords_Finnish_OptimizeOrder_Coarse_FineSurprisal/"+os.listdir("results/forWords_Finnish_OptimizeOrder_Coarse_FineSurprisal/")[0], "r") as inFile:
