...
#            if slot == "Case":
 #             print(bigramSurprisal, unigramSurprisal, value, joints[slot][(stem, affixesPerSlot[slot])], numberOfValuesObservedForStemAndSlot, unigramProb, marginal_stem[slot][stem])
         else:
