def get_abstract_morphemes(labels):
    ...
    if label_dict.get("VerbForm") != "Inf":
      ...
      if mood=='Ind' and tense == "Pres" and definite == "Ind":
          ...
          byPerson = [["Past_T", "1sg_EM"], ["Past_T", "2sg_EL"], ["Past_T"], ["Past_T",  "1pl_ENK"], ["Past_T",  "2pl_TEK"], ["Past_T",  "3pl_NEK"]]
          morphs += byPerson[personNumber-1]
      elif mood == 'Ind' and tense == "Past" and definite == "Def":
          byPerson = [["Past_T", "1sg_EM"], ["Past_T", "2sg_ED"], ["Past_T"], ["Past_T",  "1pl_UK"], ["Past_T","Def_I",  "2pl_TEK"], ["Past_T", "Def_I", "3pl_NEK"]]
          morphs += byPerson[personNumber-1]
