...
#
######################################
setwd("GitHub/morpheme-ordering/utils/visualize")
data = read.csv("../finnish/analyze/results_auc_optimized.tsv", sep="\t")
...
ggsave(plot, file=paste("Finnish-suffixes-byMorphemes-auc-hist-heldout-Coarse-FineSurprisal-optimized.pdf", sep=""), height=4, width=8)
