...
PATH = "../finnish/estimates/"

files = sorted([x for x in os.listdir(PATH) if "forWords_Finnish" in x])
...
with open("../finnish/analyze/results_auc_optimized.tsv", "w") as outFile:
